...
export const mockRequests = [
  { id: 'r1', from: { name: 'Alex Chen',  major: 'CS'      }, to: { name: 'Sarah Kim'       }, message: "Hi Jordan, I'd love an intro to Sarah — I'm applying for SWE internships and her Google experience would be invaluable.", status: 'pending', intent: 'internship' },
  ...
  { id: 'r3', from: { name: 'Mia Torres', major: 'Design'  }, to: { name: 'Priya Patel'    }, message: "Hi Jordan, I saw Priya spoke at the product summit and I'd love a quick intro to ask about PM careers.",                  status: 'pending', intent: 'career'     },
];
